        ...
        const response = await axios.get(
          `${
            process.env.NODE_ENV === "production"
              ? process.env.REACT_APP_PROD_URL + "/api/historydebts"
              : process.env.REACT_APP_BACKEND_URL + "/api/historydebts"
          }`,
      ...
      <div className="flex">
        ...
        <div className="flex flex-col ">
          ...
          <div>
            ...
            {showfilter && (
              <div
                className="absolute left-58 w-36 md:w-48 bg-white border rounded-md shadow-lg z-10 "
                onClick={filterClick}
              >
                <div
              ...
              <tr key={index}>
                ...
                <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                  {item.secondname ? (
                    ...
                    <div className="text-red-400">Not Provided</div>
                  )}
                </td>
                <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                  {item.contact}
                ...
                <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                  <button
                    className="bg-green-400 rounded-lg px-3 py-3 text-black"
